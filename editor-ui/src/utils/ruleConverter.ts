...
export function generateFastlyToml(config: ServiceConfig): string {
  let toml = `# MSS Compute Service Configuration
# Generated by MSS Rule Editor
...
`
  ...
  file = "config/mss_shared_secret.json"
`
  }
 ...
 * This enables loading existing rules when selecting an MSS service.
 */
